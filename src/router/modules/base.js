    ...
    children: [
      {
        ...
        children:[
          ...
          //   meta: { title: 'ExamDetail', current: '考试详情', active:'myExam', hidden: true, icon: '&#xe615;'},
          // },
          // {
          //   path: 'myOrder',
          //   name: 'myOrder',
          ...
          //   meta: { title: 'OrderDetail', current: '订单详情', active:'myOrder', hidden: true, icon: '&#xe60b;'},
          // },
          // {
          //   path: 'myCoupon',
          //   name: 'myCoupon',
          ...
          //   meta: { title: 'ConponDesc', current: '优惠券说明', active:'myCoupon', hidden: true, icon: '&#xe616;'},
          // },
          // {
          //   path: 'myMessage',
          //   name: 'myMessage',
          ...
          //   meta: { title: 'MyIntegral', active:'myIntegral', icon: '&#xe610;'},
          // },
          // {
          //   path: 'myIntegralRanking',
          //   name: 'myIntegralRanking',
          //   component: () => import('@/pages/personal/myIntegralRanking.vue'),
          //   meta: { title: 'Ranking',current: '优惠券说明', active:'myIntegral', hidden: true, icon: '&#xe610;'},
          // },
          // {
          //   path: 'myCollect',
          //   name: 'myCollect',
